...
class Trend
{
    ...
    public function mysqlAdapter(string $column, string $interval): string
    {
    ...
    {
        return $this->mysqlAdapter($this->builder->getModel()->getTable() . '.' . $this->dateColumn, $this->interval);
//        return $this->mysqlAdapter($this->dateColumn, $this->interval);
    }
